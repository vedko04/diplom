...
import {BoundingBox} from '../../components/containers/bounding_box';
import {NormalizedLandmark} from '../../components/containers/landmark';
import {
  CategoryMaskShaderContext,
  CategoryToColorMap,
  RGBAColor,
} from './drawing_utils_category_mask';
import {ConfidenceMaskShaderContext} from './drawing_utils_confidence_mask';
